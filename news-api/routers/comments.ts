...
commentsRouter.post('/', async (req,res,next)=>{
  ...
  if(news_id){
    ...
    await mysqlDb.getConnection().query('INSERT INTO comments (news_id, author, content) VALUES (?, IFNULL(?, DEFAULT(author)),?)', [comment.news_id, comment.author, comment.content]);
